...
var marshalTests = []struct {
	...
	{
		ExpectXML: `<XMLNSFieldStruct xmlns="httpim://example.com/ns"><Body>hello world</Body></XMLNSFieldStruct>`,
		Value:     &XMLNSFieldStruct{Ns: "httpim://example.com/ns", Body: "hello world"},
	},
	{
		ExpectXML: `<testns:test xmlns:testns="testns" xmlns="httpim://example.com/ns"><Body>hello world</Body></testns:test>`,
		Value:     &NamedXMLNSFieldStruct{Ns: "httpim://example.com/ns", Body: "hello world"},
	},
	{
