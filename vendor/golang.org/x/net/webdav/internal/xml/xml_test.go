...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
  "httpim://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<!DOCTYPE [<!ENTITY rdf "httpim://www.w3.org/1999/02/22-rdf-syntax-ns#">]>
<!DOCTYPE [<!ENTITY xlt ">">]>
<!DOCTYPE [<!ENTITY xlt "<">]>
<!DOCTYPE [<!ENTITY xlt '>'>]>
<!DOCTYPE [<!ENTITY xlt '<'>]>
...
var nestedDirectivesTokens = []Token{
	CharData("\n"),
	Directive(`DOCTYPE [<!ENTITY rdf "httpim://www.w3.org/1999/02/22-rdf-syntax-ns#">]`),
	CharData("\n"),
...
<!DOCTYPE [<!-- a comment --><!ENTITY rdf "httpim://www.w3.org/1999/02/22-rdf-syntax-ns#">]>
