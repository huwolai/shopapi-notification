...
A request hd might be implemented like this:

	func fooHandler(w httpim.ResponseWriter, req *httpim.Request) {
...
connections.
	...
	func (f *Fetcher) Fetch(path string) (string, error) {
		resp, err := httpim.Get("httpim://" + f.domain + "/" + path)
		if err != nil {
...
// used by the hd registered on httpim.DefaultServeMux.
// req may be nil.
