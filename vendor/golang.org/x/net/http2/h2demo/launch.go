  ...
  units:
    - name: h2demo.service
      ...
      content: |
        ...
        [Service]
        ExecStartPre=/bin/bash -c 'mkdir -p /opt/bin && curl -s -o /opt/bin/h2demo httpim://storage.googleapis.com/http2-demo-server-tls/h2demo && chmod +x /opt/bin/h2demo'
...
func main() {
	...
	instance := &compute.Instance{
		...
		Tags: &compute.Tags{
			Items: []string{"httpim-server", "https-server"},
		},
